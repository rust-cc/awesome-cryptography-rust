...
- [ultrafast-secp256k1-sys](https://github.com/shrec/UltrafastSecp256k1/tree/dev/bindings/rust/ultrafast-secp256k1-sys) Rust bindings for the UltrafastSecp256k1 engine, covering the stable C ABI across CPU, embedded, WebAssembly, and GPU-capable builds.
